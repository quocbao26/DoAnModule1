...
from Xu_ly.Quan_ly_Cong_ty.Xu_ly import *
...
def index():
    ...
    if request.method == 'POST':
        ...
        if Ma_so == 'TRA_CUU':
            ...
            url_MH = "/Quan_ly_Cong_ty/Tra_cuu/" + Chuoi_Tra_Cuu + "/"
        # PHIEU_NHAP
        if Ma_so == 'SO_LUONG_TON':
            url_MH = "/Quan_ly_Cong_ty/Thong_ke_so_luong_ton/"
        if Ma_so == 'DOANH_THU_TIVI':
            url_MH = "/Quan_ly_Cong_ty/Thong_ke_doanh_thu_theo_tivi/"
        if Ma_so == 'DOANH_THU_NHAN_VIEN':
            url_MH = "/Quan_ly_Cong_ty/Thong_ke_doanh_thu_theo_nhan_vien/"

    return render_template('Quan_ly_Cong_ty/MH_Chinh.html', Dia_chi_MH=url_MH, Chuoi_HTML_Quan_ly=Chuoi_HTML_Quan_ly)
...
# @app.route('/Quan_ly_Cong_ty/CapNhat/<string:Ma_so>/', methods=['GET', 'POST'])
...
#         return render_template('Quan_ly_Cong_ty/MH_Cap_Nhap_Tivi.html', Chuoi_HTML_Tivi=Chuoi_HTML_Tivi)


@app.route('/Quan_ly_Cong_ty/Thong_ke_so_luong_ton/', methods=['GET', 'POST'])
...
@app.route('/Quan_ly_Cong_ty/Thong_ke_doanh_thu_theo_tivi/', methods=['GET', 'POST'])
def Liet_ke_doanh_thu_theo_Tivi():
    ...
    return render_template('Quan_ly_Cong_ty/MH_Xem_Doanh_thu_Tivi.html', Chuoi_HTML_Thong_ke_Tivi=Chuoi_HTML_Thong_ke_Tivi)

@app.route('/Quan_ly_Cong_ty/Thong_ke_doanh_thu_theo_nhan_vien/', methods=['GET', 'POST'])
def Liet_ke_doanh_thu_theo_nhan_vien():
    ...
    return render_template('Quan_ly_Cong_ty/MH_Xem_Doanh_thu_Nhan_vien.html', Chuoi_HTML_Thong_ke_Nhan_vien=Chuoi_HTML_Thong_ke_Nhan_vien)
