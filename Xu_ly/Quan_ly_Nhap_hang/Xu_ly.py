...
def Ghi_Tivi(Tivi, don_gia_nhap):
...
def Tong_ket_Danh_sach_Tivi(Danh_sach_Tivi):
    Danh_sach = {}
    lst_ma  = []
    lst_ten = []
    tong_all = 0
...
def Tao_Chuoi_HTML_Tivi(Tivi, Thong_bao, Don_gia_nhap_moi):
              ...
              <form method="POST">
                <div class="container-fluid">
                  <div class="alert" style="height:30px">
                    <input name="Th_Don_gia" type="number" required min="1" max="'''+ str(Tivi["Don_gia_Nhap"])+'''" spellcheck="false" 
                    autocomplete="off" value="'''+ str(Don_gia_nhap_moi) + '''"
                    />
                  </div>
...
def Tao_Chuoi_HTML_Danh_sach_Tivi(Danh_sach_Tivi):   
    ...
    for Tivi in Danh_sach_Tivi:        
        ...
        Chuoi_Thong_tin='<div class="btn" style="text-align:left">' + \
                 ...
                 Chuoi_SL_Ton + \
                 '''<a href="/Quan_ly_Nhap_hang/CapNhat/''' + Tivi["Ma_so"] +'''/">Cập nhật</a>'''+ '</div>'
